...
if __name__ == "__main__":
    ...
    x_train_file = "Colon_train_cd40.csv"
    x_test_file = "ACPs_generated.csv"
    x_train_output = "Colon_train_cd40_onehot_candidate.csv"
    x_test_output = "Colon_test_cd40_onehot_candidate.csv"
