...
if __name__ == "__main__":
    ...
    x_test_file = "ACP_candidate_selected_7_sequences_for_synthesis.csv"
    x_train_output = "AIP_x_train_onehot_candidate.csv"
    x_test_output = "AIP_x_test_onehot_candidate.csv"
